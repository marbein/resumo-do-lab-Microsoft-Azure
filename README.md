...
- **Fatores que afetam os custos:**
    ...
    - Manutenção: Monitorar e manter recursos que nao sao mais necessarios;
    - Area geograficas: Mesmo recursos em areas geografias diferentes, custos de impostos afetam o preço dependendo do local;
    - Trafego de rede: Dependendo de onde saira e pra onde ira os dados, a uma cobrança;
    - Assinatura: Tipo e configuração pode afetar o custo;
- **Azure Marketplace:** Permite que os clientes encontrem, experimente, comprem e provisionem aplicativos e serviços de centenas de outros provedores;
- **Calculadora de preço:** Faz uma estimativa de preço, varios fatores podem alterar o valor no final;
    - Regiao;
    - Camada;
    - Opções de cobrança;
    - Opçoes de suporte;
    - Programas e ofertas;
    - Preço de desenvolvimento/teste azure
- **Calculadora de custo total de propriedade(TCO):** Ferramenta para estimar a economia de custos possivel ao migrar para o Azure, que compara os custos das infraestrutura locais com os custos de produtos e serviços Azure;
- **Relatorio:**
    - Relatorio de cobrança: relatorio gerado final do mes de quanto foi ultilizado e que ira ser cobrado;
        - Orçamento: define orçamentos gastos;
